...
const PurseInfoBox = ({ icon:Icon, dataKey, dataValue }) => {
  ...
  return (
    <div className = "bg-overlay-purse bg-cover bg-right bg-no-repeat h-auto md:h-28  bg-pallet-3 p-2 sm:py-4 md:py-2 rounded-xl md:rounded-2xl items-center border-purple-1 border flex flex-col sm:flex-row">
