    ...
    return (
        <React.Fragment>
            <div className={`h-auto lg:w-1/2  dark:bg-gray-16 bg-blue-7 p-6 rounded-xl mt-8`}>
                ...
                <button  onClick={depositFundsToBentoBox} className="Poppins bg-btn ml-4 cursor-pointer rounded-md h-10 flex  capitalize items-center justify-center p-4 text-white-1 text-sm">move funds to bentoBox</button>
                    ...
                    <button  onClick={withdrawFundsFromBentoBox} className="Poppins capitalize bg-btn ml-4 cursor-pointer rounded-md h-10 flex items-center justify-center p-4 text-white-1 text-sm">
