        ...
        <React.Fragment>
            <div className="flex flex-col items-center">
                ...
                <div className="text-white-1 mt-12 flex justify-between lg:w-2/5">
                    <p className={`Poppins ${theme === 'dark'? 'text-white-1' : 'text-dark-1'} font-medium text-sm`}>Available Members</p>
                    <p className={`Poppins ${theme === 'dark'? 'text-white-1' : 'text-dark-1'} font-medium text-sm`}>Members Expected</p>
                </div>
                <div className="mt-8">
