...
import { innerNav, tokenData } from "../../static/data";
              ...
              <div className="border-0 rounded-lg bg-dark-4 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="pl-4 pr-8 pt-4 pb-12">
                  <div className="flex justify-between pt-4">
                    <div>
                      <p className="Poppins text-white-1 font-thin text-sm mb-1">
                        Swap from
                      </p>
                    ...
                    <div className="flex items-center">
                      ...
                      <div onClick={() => setShow(!show)} className="flex items-center">
                        <button className="ml-2 mr-2 text-white">ETH </button>
                  ...
                  <div className="flex justify-between pt-4 mb-4">
                    <div>
                      <p className="Poppins text-white-1 font-thin text-sm mb-2">
                        Swap from
                      </p>
                      <input placeholder="0" className="w-1/4 border-none outline-none bg-transparent text-center placeholder:font-extrabold placeholder:text-2xl" />
                      <p className="Poppins text-white-1 font-thin text-sm">
          ...
          <div className="justify-center items-center shadow-lg flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative px-4 w-full max-w-md h-full md:h-auto">
              ...
              <div className="border-0 rounded-lg bg-dark-4 shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="pl-4 pr-8 pt-4 pb-12">
                  <div className="flex items-center">
                  <h5 className="text-white mr-2 font-Poppins font-normal">Slippage Tolerance</h5>
                  <p className="text-white"><BsQuestionCircle/></p>
                  </div>
