...
const ModalWrapper = ({open, children, onClose, label}) => {
  return (
    <Modal
      ...
      className = {clsx({"absolute top-1/2 left-1/2 w-72 md:w-96 -translate-x-1/2 -translate-y-full opacity-0 bg-gray-4 p-6 rounded-3xl -z-20 modal":true, "show-modal": open })}
    >
      {children}
    </Modal>
  )
