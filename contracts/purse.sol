...
contract PurseContract{
    ...
    mapping(address => uint256) public contract_total_deposit_balance;//maps address of contract to deposits made by all members
   ...
   /**  @notice upon joining a purse, you need not include deposit amount
    ...
    function joinPurse( uint _collateral) public {
